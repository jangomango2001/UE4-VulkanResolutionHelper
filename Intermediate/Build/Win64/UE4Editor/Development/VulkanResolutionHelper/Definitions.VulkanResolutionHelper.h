#undef VULKANRESOLUTIONHELPER_API
...
#define UE_PROJECT_NAME VulkanPlugin
#define UE_TARGET_NAME VulkanPluginEditor
...
#define VULKANRESOLUTIONHELPER_API DLLEXPORT
